...
- 关于老师在微信群中提出的问题，我算出的2016年第一季度数据也是6.8%，也和统计局公布的数据相差0.1%，查阅资料后，在[《2018年中国统计年鉴》](http://www.stats.gov.cn/tjsj/ndsj/2018/indexch.htm)中的“国民经济核算”部分发现这样一个注释：

  ![基期变化](https://github.com/ChenM-7/CM-task/blob/master/week3/15%20%E5%9F%BA%E6%9C%9F%E8%AE%A1%E7%AE%97.png)

  2016年就是基期变化的一年，那么按照统计年鉴中的说法就会有两个不变价数据——这是否有可能就是导致国家统计局数据和我们算出来的数据不一致的原因？
  
  不过这只是我的一个猜测，因为我没能查到2016年的“另一个”不变价数据，而且其他季度的数据也没有偏差。
